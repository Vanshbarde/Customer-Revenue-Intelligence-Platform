...
class BusinessQAEngine:
    ...
    def recommend_product_campaign(self):
        ...
        category = self.get_top_category()
    ...
    def answer_high_value_customers(self):
        ...
        customers = self.get_high_value_customers()
    ...
    def answer_total_customers(self):
        ...
        return f"Total customers are {customers:,}"
    ...
    def answer_total_orders(self):
        ...
        return f"Total orders are {orders:,}"
    ...
    def answer_top_category(self):
        ...
        return f"Top category is {category}"
    
    
    def answer_top_city(self):
    
        city = self.get_top_city()
    ...
    def answer_purchase_probability(self):
        ...
        prob = self.get_avg_purchase_probability()
    
        return (
            f"Average purchase probability is "
            f"{prob:.2f}%"
        )
    ...
    def answer_opportunity_score(self):
        ...
        score = self.get_total_opportunity_score()
